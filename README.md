...
Сущность Menu характеризуется такими полями как: IdMenu целочисленного типа, Dish целочисленного типа, Photo типа image, Ingridient символьного типа, Portion целочисленного типа, Price денежного типа. Аналогично с остальными сущностями.
